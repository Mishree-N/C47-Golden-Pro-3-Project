...
function draw() {
  ...
  if(gameState==WIN){
    ...
    //display image of squirrel with family
...
function squirrelCollide(){
  ...
  squirrel.collide (m28);
  squirrel.collide (m28);
  squirrel.collide (m30);
  squirrel.collide (m31);
...
function snakesCollide(){
  ...
  snake.bounceOff (m17);
        ...
        snake2.bounceOff (m8);
        snake2.bounceOff (m9);
        snake2.bounceOff (m10);
        snake2.bounceOff (m11);
        snake2.bounceOff (m12);
        snake2.bounceOff (m13);
        snake2.bounceOff (m14);
        snake2.bounceOff (m15);
        snake2.bounceOff (m16);
        snake2.bounceOff (m17);
        snake2.bounceOff (m18);
        snake2.bounceOff (m19);
        snake2.bounceOff (m20);
        snake2.bounceOff (m21);
        snake2.bounceOff (m22);
        snake2.bounceOff (m23);
        snake2.bounceOff (m24);
        snake2.bounceOff (m25);
        snake2.bounceOff (m26);
        snake2.bounceOff (m27);
        snake2.bounceOff (m28);
        snake2.bounceOff (m29);
        snake2.bounceOff (m30);
        snake2.bounceOff (m31);
        snake2.bounceOff(m32);
        snake2.bounceOff(m33);
        snake2.bounceOff(m34);
        ...
        snake3.bounceOff (m8);
        snake3.bounceOff (m9);
        snake3.bounceOff (m10);
        snake3.bounceOff (m11);
        snake3.bounceOff (m12);
        snake3.bounceOff (m13);
        snake3.bounceOff (m14);
        snake3.bounceOff (m15);
        snake3.bounceOff (m16);
        snake3.bounceOff (m17);
        snake3.bounceOff (m18);
        snake3.bounceOff (m19);
        snake3.bounceOff (m20);
  snake3.bounceOff (m21);
  snake3.bounceOff (m22);
  snake3.bounceOff (m23);
  snake3.bounceOff (m24);
  snake3.bounceOff (m25);
  snake3.bounceOff (m26);
  snake3.bounceOff (m27);
  snake3.bounceOff (m28);
  snake3.bounceOff (m29);
  snake3.bounceOff (m30);
  snake3.bounceOff (m31);
  snake3.bounceOff(m32);
  snake3.bounceOff(m33);
  snake3.bounceOff(m34);
